...
function MainContent() {
  const scrollToTarget = () => { //Scroll to the About Me section
  ...
  return (
    <div className="main__content">
      ...
      <p className="aboutme__text">
        ...
        Warsaw, Poland, but I`m happy working remotely and have experience in remote
        teams. When I`m not coding, you`ll find me in a boxing gym. Boxing helps
        me to clear my mind and get an inner strength.
      </p>
